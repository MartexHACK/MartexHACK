...
|---|---|---|
| 🔎 **[leakhunt](https://github.com/MartexHACK/leakhunt)** | Static linter that catches data leakage in time-series ML code — scaler fitted before the split, centred windows, backward fill. Zero dependencies, runs in pre-commit | <img src="https://img.shields.io/github/stars/MartexHACK/leakhunt?style=flat-square&labelColor=0D1117&color=D29922" alt="stars" /> |
